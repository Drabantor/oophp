...
class DiceController implements AppInjectableInterface
{
    ...
    public function setupActionGet() : object
    {
        ...
        $game = new DiceGame($session->get("numberofplayers"), true, $session->get("numberofdices"));

        $session->set("game", $game);
        $session->set("sum", $game -> getTheSum());
    ...
    public function playActionPost() : object
    {
        ...
        $session->set("player", $game->getCurrentPlayer());
        $session->set("totals", $game->getPlayersPoints());
        $session->set("next", $game->forceNextTurn());
        $session->set("winner", $game->checkWhoWins());
        $session->set("histogram", $game->getHistogram());
    ...
    public function setupActionPost() : object
    {
        ...
        $session->set("numberofplayers", $request->getPost("players", 2));
        $session->set("numberofdices", $request->getPost("dices", 3));
